// Generated by gencpp from file extended_object_detection/ComplexObject.msg
// DO NOT EDIT!


#ifndef EXTENDED_OBJECT_DETECTION_MESSAGE_COMPLEXOBJECT_H
#define EXTENDED_OBJECT_DETECTION_MESSAGE_COMPLEXOBJECT_H
...
struct ComplexObject_
{
  typedef ComplexObject_<ContainerAllocator> Type;
  ...
  ComplexObject_(const ContainerAllocator& _alloc)
    : type_id(0)
    , type_name(_alloc)
    , score(0.0)
    , rect(_alloc)
  ...
  typedef boost::shared_ptr< ::extended_object_detection::ComplexObject_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::extended_object_detection::ComplexObject_<ContainerAllocator> const> ConstPtr;

}; // struct ComplexObject_

typedef ::extended_object_detection::ComplexObject_<std::allocator<void> > ComplexObject;

typedef boost::shared_ptr< ::extended_object_detection::ComplexObject > ComplexObjectPtr;
typedef boost::shared_ptr< ::extended_object_detection::ComplexObject const> ComplexObjectConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::extended_object_detection::ComplexObject_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::extended_object_detection::ComplexObject_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::extended_object_detection::ComplexObject_<ContainerAllocator1> & lhs, const ::extended_object_detection::ComplexObject_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::extended_object_detection::ComplexObject_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::extended_object_detection::ComplexObject_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::extended_object_detection::ComplexObject_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::extended_object_detection::ComplexObject_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::extended_object_detection::ComplexObject_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::extended_object_detection::ComplexObject_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::extended_object_detection::ComplexObject_<ContainerAllocator> >
{
  ...
  static const char* value(const ::extended_object_detection::ComplexObject_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3993aebfee64aed7ULL;
  static const uint64_t static_value2 = 0x40beacfc2837e451ULL;
};

template<class ContainerAllocator>
struct DataType< ::extended_object_detection::ComplexObject_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::extended_object_detection::ComplexObject_<ContainerAllocator> >
{
  static const char* value()
  {
    return "int32 type_id                                       # id of object type, according to ObjectBase\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::extended_object_detection::ComplexObject_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::extended_object_detection::ComplexObject_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::extended_object_detection::ComplexObject_<ContainerAllocator>& v)
  {
    s << indent << "type_id: ";
...
#endif // EXTENDED_OBJECT_DETECTION_MESSAGE_COMPLEXOBJECT_H
