...
"""autogenerated by genpy from grasping_msgs/Object.msg. Do not edit."""
import codecs
import sys
...
class Object(genpy.Message):
  _md5sum = "0770e300363d18954f6fd25963e4d536"
  _type = "grasping_msgs/Object"
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','string','grasping_msgs/ObjectProperty[]','sensor_msgs/PointCloud2','shape_msgs/SolidPrimitive[]','geometry_msgs/Pose[]','shape_msgs/Mesh[]','geometry_msgs/Pose[]','shape_msgs/Plane']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,support_surface,properties,point_cluster,primitives,primitive_poses,meshes,mesh_poses,surface
    ...
    if args or kwds:
      ...
      if self.properties is None:
        self.properties = []
      if self.point_cluster is None:
        self.point_cluster = sensor_msgs.msg.PointCloud2()
      ...
      if self.surface is None:
        self.surface = shape_msgs.msg.Plane()
    else:
      self.header = std_msgs.msg.Header()
      self.name = ''
      self.support_surface = ''
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.properties:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.point_cluster.header.seq, _x.point_cluster.header.stamp.secs, _x.point_cluster.header.stamp.nsecs))
      _x = self.point_cluster.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2I().pack(_x.point_cluster.height, _x.point_cluster.width))
      length = len(self.point_cluster.fields)
      buff.write(_struct_I.pack(length))
      for val1 in self.point_cluster.fields:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      _x = self
      buff.write(_get_struct_B2I().pack(_x.point_cluster.is_bigendian, _x.point_cluster.point_step, _x.point_cluster.row_step))
      _x = self.point_cluster.data
      length = len(_x)
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.point_cluster.is_dense
      ...
      for val1 in self.mesh_poses:
        ...
        _x = _v4
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
      buff.write(_get_struct_4d().pack(*self.surface.coef))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.support_surface = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      (_x.point_cluster.header.seq, _x.point_cluster.header.stamp.secs, _x.point_cluster.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.point_cluster.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.point_cluster.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.point_cluster.height, _x.point_cluster.width,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.point_cluster.fields = []
      for i in range(0, length):
        ...
        self.point_cluster.fields.append(val1)
      _x = self
      start = end
      end += 9
      (_x.point_cluster.is_bigendian, _x.point_cluster.point_step, _x.point_cluster.row_step,) = _get_struct_B2I().unpack(str[start:end])
      self.point_cluster.is_bigendian = bool(self.point_cluster.is_bigendian)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.point_cluster.data = str[start:end]
      start = end
      end += 1
      (self.point_cluster.is_dense,) = _get_struct_B().unpack(str[start:end])
      self.point_cluster.is_dense = bool(self.point_cluster.is_dense)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.primitives = []
      ...
      self.surface.coef = _get_struct_4d().unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.mesh_poses:
        ...
        _x = _v12
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
      buff.write(self.surface.coef.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.surface.coef = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=4)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
