...
"""autogenerated by genpy from grasping_msgs/GraspPlanningActionResult.msg. Do not edit."""
import codecs
import sys
...
class GraspPlanningActionResult(genpy.Message):
  ...
  _type = "grasping_msgs/GraspPlanningActionResult"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','grasping_msgs/GraspPlanningResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = grasping_msgs.msg.GraspPlanningResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = grasping_msgs.msg.GraspPlanningResult()
