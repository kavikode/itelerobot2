...
bool operator==(const ::grasping_msgs::FindGraspableObjectsActionResult_<ContainerAllocator1> & lhs, const ::grasping_msgs::FindGraspableObjectsActionResult_<ContainerAllocator2> & rhs)
{
