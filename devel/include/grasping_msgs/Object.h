...
bool operator==(const ::grasping_msgs::Object_<ContainerAllocator1> & lhs, const ::grasping_msgs::Object_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.name == rhs.name &&
    lhs.support_surface == rhs.support_surface &&
    lhs.properties == rhs.properties &&
    lhs.point_cluster == rhs.point_cluster &&
