...
if("TRUE" STREQUAL "TRUE")
  set(grasping_msgs_SOURCE_PREFIX /home/kavihost/catkin_ws/src/grasping_msgs)
  set(grasping_msgs_DEVEL_PREFIX /home/kavihost/catkin_ws/devel)
  ...
  set(grasping_msgs_INSTALL_PREFIX /home/kavihost/catkin_ws/install)
...
if(NOT "/home/kavihost/catkin_ws/devel/include " STREQUAL " ")
  set(grasping_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/kavihost/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/grasping_msgs " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/grasping_msgs' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Michael Ferguson <mfergs7@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'grasping_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kavihost/catkin_ws/src/grasping_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT grasping_msgs_NUM_DUMMY_TARGETS)
      set(grasping_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::grasping_msgs::wrapped-linker-option${grasping_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR grasping_msgs_NUM_DUMMY_TARGETS "${grasping_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::grasping_msgs::wrapped-linker-option${grasping_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND grasping_msgs_LIBRARIES "${interface_target_name}")
...
set(depends "geometry_msgs;moveit_msgs;sensor_msgs;shape_msgs")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(grasping_msgs_EXPORTED_TARGETS ${${grasping_msgs_dep}_EXPORTED_TARGETS})
endforeach()
