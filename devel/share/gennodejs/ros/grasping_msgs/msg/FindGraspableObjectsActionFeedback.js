...
class FindGraspableObjectsActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new FindGraspableObjectsFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type FindGraspableObjectsActionFeedback
    ...
    bufferOffset = FindGraspableObjectsFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type FindGraspableObjectsActionFeedback
    let len;
    let data = new FindGraspableObjectsActionFeedback(null);
    ...
    data.feedback = FindGraspableObjectsFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += FindGraspableObjectsFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FindGraspableObjectsActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = FindGraspableObjectsFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new FindGraspableObjectsFeedback()
    }
...
module.exports = FindGraspableObjectsActionFeedback;
