...
class FindGraspableObjectsAction {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('action_goal')) {
        ...
        this.action_goal = new FindGraspableObjectsActionGoal();
      }
      if (initObj.hasOwnProperty('action_result')) {
        this.action_result = initObj.action_result
      }
      else {
        this.action_result = new FindGraspableObjectsActionResult();
      }
      if (initObj.hasOwnProperty('action_feedback')) {
        this.action_feedback = initObj.action_feedback
      }
      else {
        this.action_feedback = new FindGraspableObjectsActionFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type FindGraspableObjectsAction
    // Serialize message field [action_goal]
    bufferOffset = FindGraspableObjectsActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = FindGraspableObjectsActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = FindGraspableObjectsActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type FindGraspableObjectsAction
    let len;
    let data = new FindGraspableObjectsAction(null);
    // Deserialize message field [action_goal]
    data.action_goal = FindGraspableObjectsActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = FindGraspableObjectsActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = FindGraspableObjectsActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += FindGraspableObjectsActionGoal.getMessageSize(object.action_goal);
    length += FindGraspableObjectsActionResult.getMessageSize(object.action_result);
    length += FindGraspableObjectsActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FindGraspableObjectsAction(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = FindGraspableObjectsActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new FindGraspableObjectsActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = FindGraspableObjectsActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new FindGraspableObjectsActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = FindGraspableObjectsActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new FindGraspableObjectsActionFeedback()
    }
...
module.exports = FindGraspableObjectsAction;
