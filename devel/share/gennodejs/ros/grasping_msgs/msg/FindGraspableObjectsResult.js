...
class FindGraspableObjectsResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize the length for message field [support_surfaces]
    bufferOffset = _serializer.uint32(obj.support_surfaces.length, buffer, bufferOffset);
    obj.support_surfaces.forEach((val) => {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FindGraspableObjectsResult(null);
    // Deserialize message field [objects]
    // Deserialize array length for message field [objects]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.objects = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.objects[i] = GraspableObject.deserialize(buffer, bufferOffset)
    }
    // Deserialize message field [support_surfaces]
    // Deserialize array length for message field [support_surfaces]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.support_surfaces = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.support_surfaces[i] = Object.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FindGraspableObjectsResult(null);
    if (msg.objects !== undefined) {
      resolved.objects = new Array(msg.objects.length);
      for (let i = 0; i < resolved.objects.length; ++i) {
        resolved.objects[i] = GraspableObject.Resolve(msg.objects[i]);
      }
    }
    else {
      resolved.objects = []
    ...
    if (msg.support_surfaces !== undefined) {
      resolved.support_surfaces = new Array(msg.support_surfaces.length);
      for (let i = 0; i < resolved.support_surfaces.length; ++i) {
        resolved.support_surfaces[i] = Object.Resolve(msg.support_surfaces[i]);
      }
    }
    else {
...
module.exports = FindGraspableObjectsResult;
