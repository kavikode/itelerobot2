...
class FindGraspableObjectsActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new FindGraspableObjectsResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FindGraspableObjectsResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FindGraspableObjectsActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = FindGraspableObjectsResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += FindGraspableObjectsResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FindGraspableObjectsActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = FindGraspableObjectsResult.Resolve(msg.result)
    }
    else {
      resolved.result = new FindGraspableObjectsResult()
    }
...
module.exports = FindGraspableObjectsActionResult;
