...
class FindGraspableObjectsActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new FindGraspableObjectsGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FindGraspableObjectsGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FindGraspableObjectsActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = FindGraspableObjectsGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FindGraspableObjectsActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = FindGraspableObjectsGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new FindGraspableObjectsGoal()
    }
...
module.exports = FindGraspableObjectsActionGoal;
